...
export const createDemoTasks = (): Task[] => [
  {
    id: 'task-demo-1',
    title: 'Собрать идеи по улучшению обработки ошибок API-клиента',
    description:
      'Зафиксировать гипотезы по типизированной обработке ошибок для fetch-обёрток и набросать варианты более понятных сообщений при проблемах с авторизацией и лимитами.',
    priority: 'high',
  ...
  {
    id: 'task-demo-3',
    title: 'Подготовить план изменений для CI',
    description:
      'Разбить обновление CI на этапы, проверить стратегию кеширования и согласовать порядок внедрения перед началом работ.',
    priority: 'high',
    tags: ['планирование', 'devops'],
